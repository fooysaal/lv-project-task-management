...
export default function EditTeam() {
    ...
    const handleUserToggle = (userId: number, isChecked: boolean) => {
        setData('user_ids', isChecked ? [...data.user_ids, userId] : data.user_ids.filter((id) => id !== userId));
    };
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Select value={data.team_type_id} onValueChange={(value) => setData('team_type_id', value)}>
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input id="name" value={data.name} onChange={(e) => setData('name', e.target.value)} required placeholder="Team name" />
