...
export default function EditProject() {
  const { project, teams, categories, currencies } = usePage().props as {
    project: any
    ...
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
        <div className="flex items-center justify-between">
          <HeadingSmall title="Edit Project" description={`Update the project: ${project.name}`} />
          <Link href="/projects">
        ...
        <form onSubmit={submit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="grid gap-2">
              ...
              <Select
                onValueChange={(val) => setData('team_id', val)}
                defaultValue={String(data.team_id)}
              >
                <SelectTrigger>
            ...
            <div className="grid gap-2">
              ...
              <Select
                onValueChange={(val) => setData('project_category_id', val)}
                defaultValue={String(data.project_category_id)}
              >
                <SelectTrigger>
